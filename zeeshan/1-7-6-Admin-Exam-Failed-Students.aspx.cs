...
namespace Future
{
    public partial class _1_7_6_Admin_Exam_Failed_Students : System.Web.UI.Page
    {
        int term = 1;
        ...
        protected void ddlSection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlSection.SelectedIndex != 0)
            {
                ...
                st.termOfClass = term;
                Session["classForFailedStudents"] = ddlClass.SelectedItem.Text;
                Session["sectionForFailedStudents"] = ddlSection.SelectedItem.Text;
                Session["termForFailedStudents"] = term;
        ...
        {
            Session["RFailedStudents"] = ViewState["promotedStudents"];
            Response.Redirect("Report-FailedStudents.aspx");
        }
        ...
        protected void dgvPromotedStudents_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "dgvEmail")
            {
                ...
                Exam_bll bll = new Exam_bll();
                bll.SendEmailToOneFail(AddmissionId, cls, section, trm);
        ...
        protected void btnEmail_Click(object sender, EventArgs e)
        {
            ...
            Exam_bll bll = new Exam_bll();
            bll.SendEmailToAllFail(dt, cls, section, trm);
