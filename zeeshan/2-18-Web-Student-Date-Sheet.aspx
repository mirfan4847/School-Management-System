<%@ Page Title="" Language="C#" MasterPageFile="~/My Master Page.Master" AutoEventWireup="true" CodeBehind="2-18-Web-Student-Date-Sheet.aspx.cs" Inherits="zeeshan._2_18_Web_Student_Date_Sheet" %>
    ...
    <div id="RecordNotFound" class="modal fade">
     ...
     <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="2-18-Web-Student-Date-Sheet?m=1" >First Term</a></li>
            <li><a  class="btn btn-primary btn-xs"   href="2-18-Web-Student-Date-Sheet?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs"  href="2-18-Web-Student-Date-Sheet?m=3">Third Term</a></li>
