<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-8-5-Admin-Print-Monthly-Fees.aspx.cs" Inherits="Future._1_8_5_Admin_Print_Monthlt_Fees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=1">January</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=2">February</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=3">March</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=4">April</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=5">May</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=6 ">June</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=7">July</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=8">August</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=9">September</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=10">October</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=11">November</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-5-Admin-Print-Monthly-Fees.aspx?m=12">December</a></li>
        </ul>
        <div id="my-tab-content" class="tab-content">
            <div class="tab-pane active">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    ...
                    <h3 class="text-info">Monthly Fees Details</h3>
                </div>
        ...
        <asp:GridView ID="dgvMonthlyFee" runat="server" AutoGenerateColumns="False" ShowFooter="true" ShowHeader="true" ShowHeaderWhenEmpty="True">
            <Columns>
                <%--Sr--%>
                <asp:TemplateField>
