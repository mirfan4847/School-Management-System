<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-7-2-Admin-Exam-Make-Date-Sheet.aspx.cs" Inherits="Future.Make_Date_Sheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%--Record Not Found--%>
    <div id="RecordNotFound" class="modal fade">
     ...
     <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-7-2-Admin-Exam-Make-Date-Sheet.aspx?m=1" >First Term</a></li>
            <li><a  class="btn btn-primary btn-xs"   href="1-7-2-Admin-Exam-Make-Date-Sheet.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs"  href="1-7-2-Admin-Exam-Make-Date-Sheet.aspx?m=3">Third Term</a></li>
    ...
    <div class=" col-xs-4  col-sm-3 col-sm-offset-5  text-right   col-md-3 col-md-offset-5  col-lg-4 col-lg-offset-4  ">
        <asp:Button ID="Print" runat="server" Text="Print" CssClass="btn btn-primary btnlg" Visible="false" OnClick="Print_Click" />
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-9 col-md-offset-2 col-lg-offset-3 table-responsive">
                ...
                <asp:GridView ID="dgvDateSheet" runat="server" AutoGenerateColumns="false" OnRowCancelingEdit="Cancel_Editing" OnRowEditing="Edit_Row" OnRowUpdating="Update_Row">
                    <Columns>
                        <%--Sr No--%>
                        <asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEditDate" CssClass="TextBox" runat="server"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEditStartTime" runat="server" CssClass="TextBox"></asp:TextBox>
                            </EditItemTemplate>
                        ...
                        <%--End Time--%>
                         <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEditEndTime" runat="server" CssClass="TextBox"></asp:TextBox>
                            </EditItemTemplate>
     ...
     <div class=" col-xs-6 col-xs-offset-4 col-sm-3 col-sm-offset-5   col-md-3 col-md-offset-4  col-lg-4 col-lg-offset-5  ">
                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary btnlg" OnClick="btnSave_Click" Enabled="false"/>
                    <br />
                    <br />
         <br />
                    <br />
