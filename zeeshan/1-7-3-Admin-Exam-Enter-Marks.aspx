<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-7-3-Admin-Exam-Enter-Marks.aspx.cs" Inherits="Future.Enter_Marks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-7-3-Admin-Exam-Enter-Marks.aspx?m=1">First Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-7-3-Admin-Exam-Enter-Marks.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-7-3-Admin-Exam-Enter-Marks.aspx?m=3">Third Term</a></li>
