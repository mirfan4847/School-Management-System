<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-7-5-Admin-Exam-Promoted-Students.aspx.cs" Inherits="Future._1_7_5_Admin_Exam_Promoted_Students" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-7-5-Admin-Exam-Promoted-Students.aspx?m=1" >First Term</a></li>
            <li><a  class="btn btn-primary btn-xs"   href="1-7-5-Admin-Exam-Promoted-Students.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs"  href="1-7-5-Admin-Exam-Promoted-Students.aspx?m=3">Third Term</a></li>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
        ...
        <h3 class="text-info">Promoted Students</h3>
    </div>
    <br />
    <br />
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                ...
                <asp:GridView ID="dgvPromotedStudents" runat="server" OnRowCommand="dgvPromotedStudents_RowCommand" AutoGenerateColumns="false" CssClass="gv" >
                    <Columns>
                        <%--Roll_No--%>
                        <asp:TemplateField>
                        ...
                        <%-- Start ofEmail--%>
                         <asp:TemplateField>
                            <HeaderTemplate>Status</HeaderTemplate>
                            <ItemTemplate>
                                <%--<asp:Button ID="btnEmail" runat="server" Text="Email" CssClass="btn btn-primary btn-md Editbtn" />--%>
                                    <asp:Button ID="btnGridViewEmail" runat="server" CssClass="btn btn-primary sm" CommandArgument='<% #bind("Studentid")%>' CommandName="dgvEmail" Text="Email" />
    ...
    <div class=" col-xs-8 col-xs-offset-3 col-sm-5 col-sm-offset-4   col-md-5 col-md-offset-4  col-lg-6 col-lg-offset-4  ">
                    <asp:Button ID="btnEmail" runat="server" Text="Email TO All" CssClass="btn btn-primary btnlg"   OnClick="btnEmail_Click"/>
                    &nbsp;&nbsp;&nbsp;
