<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-7-8-Admin-Exam-Position-Holders.aspx.cs" Inherits="zeeshan._1_7_8_Admin_Exam_Position_Holders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-7-8-Admin-Exam-Position-Holders.aspx?m=1">First Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-7-8-Admin-Exam-Position-Holders.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-7-8-Admin-Exam-Position-Holders.aspx?m=3">Third Term</a></li>
        ...
        <div id="my-tab-content" class="tab-content">
            <div class="tab-pane active" id="January">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    ...
                    <h3 class="text-info">Position Holders</h3>
                </div>
                <br />
                <br />
