<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="Report-SetFees.aspx.cs" Inherits="zeeshan.Report_SetFees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-12 text-center">
        ...
        <div class="col-lg-8 col-md-9 col-sm-7 col-xs-12">
            ...
            <h2 class="text-info">
                <asp:Label ID="Label1" runat="server" Text="Set Fee For Classes "></asp:Label>
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("id") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate><h3>Class_Fees</h3></HeaderTemplate>
                                <ItemTemplate>
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("Fees") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
