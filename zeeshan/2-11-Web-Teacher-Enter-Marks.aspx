<%@ Page Title="" Language="C#" MasterPageFile="~/My Master Page.Master" AutoEventWireup="true" CodeBehind="2-11-Web-Teacher-Enter-Marks.aspx.cs" Inherits="zeeshan._2_11_Web_Teacher_Area" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="2-11-Web-Teacher-Enter-Marks.aspx?m=1">First Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-11-Web-Teacher-Enter-Marks.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-11-Web-Teacher-Enter-Marks.aspx?m=3">Third Term</a></li>
        ...
        <div id="my-tab-content" class="tab-content">
            <div class="tab-pane active" id="January">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    ...
                    <h3 class="text-info">Enter Paper Marks</h3>
                </div>
                <br />
                <br />
        ...
        <ContentTemplate>--%>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive">
                    ...
                    <asp:GridView ID="dgvEnterMarks"  runat="server" OnRowDataBound="dgvEnterMarks_RowDataBound"   AutoGenerateColumns="false" CssClass="gv" ShowFooter="False" OnRowCancelingEdit="Cancel_Editing" OnRowEditing="Edit_Row" OnRowUpdating="Update_Row"   >
                        <Columns>
                            <%--Roll_No--%>
                            <asp:TemplateField>
                                <HeaderTemplate>
                               ...
                               <%-- <EditItemTemplate>
                                    <asp:TextBox ID="txtEditRollNo" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>--%>
                                <ItemTemplate>
                                    <asp:Label ID="lblRollNo"  ControlStyle-CssClass="btn btn-primary btn-xs" Text='<% #bind("AdmissionId")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                               ...
                               <%-- <EditItemTemplate>
                                    <asp:TextBox ID="txtEditName" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>--%>
                                <ItemTemplate>
                          ...
                          <%--<asp:BoundField DataField="Sub4" ControlStyle-CssClass="TextBox" HeaderText="" SortExpression="Empty" />--%>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtEditSubject1" CssClass="TextBox" runat="server"></asp:TextBox>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject2" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                 ...
                                 <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject3" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject4" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                 ...
                                 <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject5" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                  ...
                                  <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject6" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                 ...
                                 <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject7" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                 ...
                                 <EditItemTemplate>
                                    <asp:TextBox ID="txtEditSubject8" runat="server" CssClass="TextBox"></asp:TextBox>
                                </EditItemTemplate>
