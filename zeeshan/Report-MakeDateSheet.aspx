<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="Report-MakeDateSheet.aspx.cs" Inherits="zeeshan.Report_MakeDateSheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-12 text-center">
        ...
        <div class="col-lg-8 col-md-9 col-sm-7 col-xs-12">
            ...
            <h2 class="text-info" align="center">
                <asp:Label ID="Label1" runat="server" Text="Date Sheet For "></asp:Label>
            ...
            <tr>
                <td colspan="3" >
                    ...
                    <asp:GridView ID="gvSetSubjects" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate><h4 >Serial_Number</h4></HeaderTemplate>
                                <ItemTemplate>
                                    
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("Sr") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate><h4>Date</h4></HeaderTemplate>
                                <ItemTemplate>
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("Date") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate><h4>Subject_Name</h4></HeaderTemplate>
                                <ItemTemplate>
                                    <h4>
                             ...
                             <asp:TemplateField>
                                <HeaderTemplate><h4>Start_Time</h4></HeaderTemplate>
                                <ItemTemplate>
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("Start_Time") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>

                              <asp:TemplateField>
                                <HeaderTemplate><h4>End_Time</h4></HeaderTemplate>
                                <ItemTemplate>
                                    <h4>
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("End_Time") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
