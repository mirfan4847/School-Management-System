<%@ Page Title="" Language="C#" MasterPageFile="~/My Master Page.Master" AutoEventWireup="true" CodeBehind="2-16-Web-Teacher-Position-Holders.aspx.cs" Inherits="zeeshan._2_16_Web_Teacher_Position_Holders" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="2-16-Web-Teacher-Position-Holders.aspx?m=1">First Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-16-Web-Teacher-Position-Holders.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-16-Web-Teacher-Position-Holders.aspx?m=3">Third Term</a></li>
