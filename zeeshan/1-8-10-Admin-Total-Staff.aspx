<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-8-10-Admin-Total-Staff.aspx.cs" Inherits="zeeshan._1_8_10_Admin_Total_Staff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="1-8-10-Admin-Total-Staff.aspx">Science</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-10-Admin-Total-Staff.aspx?m=Arts">Arts</a></li>
              <li><a class="btn btn-primary btn-xs" href="1-8-10-Admin-Total-Staff.aspx?m=Computer Science">Computer Science</a></li>
            <li><a class="btn btn-primary btn-xs" href="1-8-10-Admin-Total-Staff.aspx?m=Administrator">Administrator</a></li>
