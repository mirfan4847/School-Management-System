<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-4-2-Admin_Edit-Student.aspx.cs" Inherits="Future._1_5_Admin_Edit_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%--Modal--%>
    ...
    <%--Student Edit Form--%>
        ...
        <h3 class="text-info">Edit Student Record </h3>
    </div>
...
<br />
   ...
   <div class="form-group">
    ...
    <%--Form 3 End--%>
     ...
     <div class=" col-xs-6 col-xs-offset-4 col-sm-3 col-sm-offset-5   col-md-3 col-md-offset-4  col-lg-4 col-lg-offset-5  ">
    <asp:Button ID="btnEdit" runat="server" Text="Save" ValidationGroup="z"  CssClass="btn btn-primary btnlg" OnClick="btnEdit_Click" />
</div>
