<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="Report-SetGrades.aspx.cs" Inherits="zeeshan.Report_SetGrades" %>
    ...
    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 text-center">
        ...
        <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
            ...
            <h2 class="text-info" align="center">
                <asp:Label ID="Label1" runat="server" Text="Grades For Classes "></asp:Label>
                <asp:Label ID="lblHeader" runat="server" ></asp:Label></h2>
        </div>
        <div class="clearfix"></div>
    <div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1" >
        <table align="center">
            <tr>
                <td colspan="3" >
                    ...
                    <asp:GridView ID="gvSetSubjects" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <h4 align="center">
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("GradeName") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate><h2>Percentage</h2></HeaderTemplate>
                                <ItemTemplate>
                                    <h4 align="center">
                             ...
                             <asp:TemplateField>
                                <HeaderTemplate><h2>Status</h2></HeaderTemplate>
                                <ItemTemplate>
                                    <h4 align="center">
                                        <asp:Label ID="Label2" runat="server" Text='<% #Bind("Status") %>' ></asp:Label></h4>
                                </ItemTemplate>
                            </asp:TemplateField>
