<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="TimeTable.aspx.cs" Inherits="zeeshan.TimeTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="zeeshan" runat="server"></asp:GridView>

            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 table-responsive">

                <asp:GridView ID="dgvClass" runat="server" AutoGenerateColumns="False" OnRowDeleting="dgvClass_RowDeleting" OnRowEditing="dgvClass_RowEditing" OnRowCancelingEdit="dgvClass_RowCancelingEdit" OnRowUpdating="dgvClass_RowUpdating" ShowHeaderWhenEmpty="True">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:Label Text="heloo" runat="server"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEditPeriod7" CssClass="TextBox" runat="server" Text='<% #bind("Lec7")%>'></asp:TextBox>
    ...
    <br />
            ...
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-4 col-lg-5 col-lg-offset-3 table-responsive">
                ...
                <asp:GridView ID="dgv" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True">
                    <Columns>
                        <%--Sr No--%>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl2" ControlStyle-CssClass="btn btn-primary btn-xs" Text="" runat="server"></asp:Label>
                            </ItemTemplate>
 ...
 <%--Text='<% #bind("Sr")%>' --%>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl1" Text='<% #bind("Name1")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl1" Text='<% #bind("Name")%>' runat="server"></asp:Label>
                            </ItemTemplate>
