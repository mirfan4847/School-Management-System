<%@ Page Title="" Language="C#" MasterPageFile="~/My Master Page.Master" AutoEventWireup="true" CodeBehind="2-10-Web-Student-Results.aspx.cs" Inherits="zeeshan._2_10_Web_Student_Area" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="content ">
        <ul id="tabs" class="nav nav-pills red" data-tabs="tabs">
            <li class="active "><a class="btn btn-primary btn-xs" href="2-10-Web-Student-Results.aspx?m=1">First Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-10-Web-Student-Results.aspx?m=2">Second Term</a></li>
            <li><a class="btn btn-primary btn-xs" href="2-10-Web-Student-Results.aspx?m=3">Third Term</a></li>
            ...
            <div class="tab-pane active" id="January">
                ...
                <div class=" col-xs-12 col-sm-6 col-md-5 col-lg-5">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlClass" runat="server" AutoPostBack="true" CssClass="form-control" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged">
