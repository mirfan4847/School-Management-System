<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="TeacherTimeTable.aspx.cs" Inherits="zeeshan.TeacherTimeTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class=" col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:DropDownList ID="ddlClass" runat="server" AutoPostBack="true" ValidationGroup="z" CssClass="form-control" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged">
                <asp:ListItem>Choose</asp:ListItem>

            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" InitialValue="Choose" runat="server" ErrorMessage="Choose Teacher" ForeColor="Red" ValidationGroup="z" ControlToValidate="ddlClass"></asp:RequiredFieldValidator>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
      ...
      <h4>   <asp:Label ID="lblTeacher" runat="server" ></asp:Label></h4>
    </div>
