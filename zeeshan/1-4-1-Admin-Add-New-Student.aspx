<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-4-1-Admin-Add-New-Student.aspx.cs" Inherits="Future._1_4_Admin_Add_New_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>
                        ...
                        No Admission Capacity Available for this Class
        ...
        <ContentTemplate>
            ...
            <div>
                ...
                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
                    <h5>Total Students:<asp:Label ID="lblTotalStudents" runat="server" Text="15" Visible="false"></asp:Label>
                    </h5>
                </div>

                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <h5>Last Admission ID was:<asp:Label ID="lblLastAdmission" runat="server" Text="02222" Visible="false"></asp:Label></h5>
                </div>

                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4 ">
                    <div class="divforimage marginImage" style="margin-left:20%">
                        <asp:Image ID="Image1" ImageUrl="~/Images/Student_Img.jpg" Height="146" Width="146" runat="server" CssClass="img-rounded" />
                        <asp:FileUpload ID="fuPicture" runat="server" onchange="ShowImagePreview(this);" />
                    </div>
                </div>
            ...
            <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlClass" runat="server" ValidationGroup="z" AutoPostBack="true" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" CssClass="form-control" AppendDataBoundItems="true">
            ...
            <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    <label>Section</label>
                    <asp:DropDownList ID="ddlSection" runat="server" CssClass="form-control" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged" AutoPostBack="true" Enabled="False">

                        <asp:ListItem>Choose Section</asp:ListItem>
                    </asp:DropDownList>



                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" InitialValue="Choose Section" runat="server" ErrorMessage="Choose Your Section" ForeColor="Red" ValidationGroup="z" ControlToValidate="ddlSection"></asp:RequiredFieldValidator>
                </div>
            </div>
            ...
            <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtAdminId" runat="server" ReadOnly="false" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="Enter a Value" ForeColor="Red" ValidationGroup="z" ControlToValidate="txtAdminId" InitialValue="Choose AdmissionId"></asp:RequiredFieldValidator>
            ...
            <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtFamilyNo" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtAdmissionDate" runat="server" CssClass="form-control editdate"></asp:TextBox>
    ...
    <div class=" col-xs-6 col-xs-offset-4 col-sm-3 col-sm-offset-5   col-md-3 col-md-offset-4  col-lg-4 col-lg-offset-5  ">
        <asp:Button ID="btnNext" runat="server" Text="Save" ValidationGroup="z" OnClick="btnNext_Click" CssClass="btn btn-primary btnlg" />
    </div>
</asp:Content>
