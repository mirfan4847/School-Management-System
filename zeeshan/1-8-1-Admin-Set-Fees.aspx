<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-8-1-Admin-Set-Fees.aspx.cs" Inherits="Future.SetFees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
        ...
        <h3 class="text-info">Set Class Fees</h3>
    </div>
            <br />
            <br />
            ...
            <%--Grid Two--%>
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-6 col-lg-5 col-lg-offset-3 table-responsive">

                <asp:GridView ID="dgv" runat="server" CssClass="margin" AutoGenerateColumns="false" OnRowDeleting="dgv_RowDeleting" OnRowEditing="dgv_RowEditing" OnRowCancelingEdit="dgv_RowCancelingEdit" OnRowUpdating="dgv_RowUpdating">
                    <Columns>
                        <%--Sr No--%>
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl2" ControlStyle-CssClass="btn btn-primary btn-xs" Text='<% #bind("id")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtEditFees" CssClass="TextBox" runat="server"></asp:TextBox>

                            </EditItemTemplate>

                            <ItemTemplate>
                                <asp:Label ID="lbl" Text='<% #bind("Fees")%>' runat="server"></asp:Label>
