<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-6-1-Admin-Add-Staff-Info.aspx.cs" Inherits="Future.Add_Staff_Info" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="addedRecord" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>
                        <asp:Label ID="lblAdded" CssClass="text-info" runat="server" Text="Please Select Class"></asp:Label></h4>
                </div>
    ...
    <div>
        ...
        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
            <h5>Last Code Number was:<asp:Label ID="lblLastCodeNo" runat="server" Text=""></asp:Label>
            </h5>
        </div>

        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <h5>Code Number:<asp:Label ID="lblCurrentCodeNo" runat="server" Text=""></asp:Label></h5>
        </div>
        ...
        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4 ">
                ...
                <asp:Image ID="Image1" ImageUrl="~/Images/Student_Img.jpg" Height="146" Width="146" runat="server" CssClass="img-rounded" />

                <asp:FileUpload ID="fuPicture" runat="server" onchange="ShowImagePreview(this);"></asp:FileUpload>
    ...
    <div class="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 table-responsive">
        <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>--%>
        <asp:GridView ID="gvAcademicQualification" runat="server" AutoGenerateColumns="False" ShowFooter="true" OnRowCancelingEdit="Cancel_AccQ" OnRowDeleting="Delete_AccQ" OnRowEditing="Edit_AccQ" OnRowUpdating="Update_AccQ">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        Qualification
                    ...
                    <EditItemTemplate>
                        <asp:DropDownList ID="ddlEditQualification" runat="server">
                            <asp:ListItem>F.A</asp:ListItem>
                            <asp:ListItem>FSc</asp:ListItem>
                            <asp:ListItem>I.Com</asp:ListItem>
                    ...
                    <FooterTemplate>
                        <asp:DropDownList ID="ddlFooterQualification" runat="server">
                            <asp:ListItem>F.A</asp:ListItem>
                            <asp:ListItem>FSc</asp:ListItem>
                            <asp:ListItem>I.Com</asp:ListItem>
                            <asp:ListItem>ICS</asp:ListItem>
                ...
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEditYearOfPassing" runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtFooterYearOfPassing" runat="server"></asp:TextBox>
                    </FooterTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:TextBox ID="txtFooterRegistrationNo" runat="server" ReadOnly="true"></asp:TextBox>
                    </FooterTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEditDevision" runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtFooterDevision" runat="server"></asp:TextBox>
                    </FooterTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEditInstitution" runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtFooterInstitution" runat="server"></asp:TextBox>
                    </FooterTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <FooterTemplate>
                        <asp:LinkButton ID="lnkbtnAddAccQ" runat="server" OnClick="lnkbtnAddAccQ_Click1">Add</asp:LinkButton>
                    </FooterTemplate>
                </asp:TemplateField>
    ...
    <div class="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 table-responsive">
        ...
        <asp:GridView ID="gvProfessionalQualification" runat="server" AutoGenerateColumns="False" ShowFooter="True" OnRowCancelingEdit="Cancel_ProfQ" OnRowDeleting="Delete_ProfQ" OnRowEditing="Edit_ProfQ" OnRowUpdating="Update_ProfQ">
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtEditQualification" runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="txtFooterQualification" runat="server"></asp:TextBox>
                    </FooterTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate></ItemTemplate>
                    <FooterTemplate>
                        <asp:LinkButton ID="lnkbtnAddProQ" runat="server" OnClick="lnkbtnAddProQ_Click">Add</asp:LinkButton>
                    </FooterTemplate>
                </asp:TemplateField>
                <asp:CommandField ShowEditButton="true" ShowDeleteButton="true" />
            </Columns>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:DropDownList ID="ddlCatogary" runat="server" CssClass="form-control">
                <asp:ListItem>Science</asp:ListItem>
                <asp:ListItem>Arts</asp:ListItem>
                <asp:ListItem>Computer Science</asp:ListItem>
                <asp:ListItem>Administrator</asp:ListItem>
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" InitialValue="Enter Trial period" ErrorMessage="Select Value" ForeColor="Red" ValidationGroup="z" ControlToValidate="ddlCatogary"></asp:RequiredFieldValidator>
    ...
    <div class=" col-xs-6 col-xs-offset-4 col-sm-3 col-sm-offset-5   col-md-3 col-md-offset-4  col-lg-4 col-lg-offset-5  ">
        <asp:Button ID="btnAdd" runat="server" Text="Add" ValidationGroup="a" CssClass="btn btn-primary btnlg" OnClick="btnAdd_Click" />
    </div>
