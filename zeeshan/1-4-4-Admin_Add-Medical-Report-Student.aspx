<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-4-4-Admin_Add-Medical-Report-Student.aspx.cs" Inherits="Future._1_4_4_Admin_Add_Report_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
        ...
        <h3 class="text-info">Add Student Medical Report</h3>
    </div>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtAdminId" runat="server" CssClass="form-control" OnTextChanged="txtAdminId_TextChanged" AutoPostBack="true"></asp:TextBox>
