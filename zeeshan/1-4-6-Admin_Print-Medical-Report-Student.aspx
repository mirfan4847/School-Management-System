<%@ Page Title="" Language="C#" MasterPageFile="~/My Admin Master.Master" AutoEventWireup="true" CodeBehind="1-4-6-Admin_Print-Medical-Report-Student.aspx.cs" Inherits="Future._1_4_6_Admin_Print_Medical_Report_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
        ...
        <h3 class="text-info">Print Student Medical Report</h3>
    </div>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtEmergencyName1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtHomeTel1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtMobile1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtEmergencyName2" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtHomeTel2" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtMobile2" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtTB" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtEpilepsy" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    ...
    <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtDiabetes" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
   ...
   <div class="form-group">
    ...
    <div class="clearfix"></div>
     ...
     <div class=" col-xs-6 col-xs-offset-4 col-sm-3 col-sm-offset-5   col-md-3 col-md-offset-4  col-lg-4 col-lg-offset-5  ">
    <asp:Button ID="btnPrint" runat="server" Text="Print" ValidationGroup="z" OnClick="btnPrint_Click" CssClass="btn btn-primary btnlg" />
</div>
</asp:Content>
